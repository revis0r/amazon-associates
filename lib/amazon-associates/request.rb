%w{errors extensions/core types/api_result 
   types/error types/bin types/search_bin_set types/customer_review types/editorial_review types/ordinal types/listmania_list types/browse_node types/measurement types/image types/image_set types/price types/offer types/item types/requests types/cart
